    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, idx: number) => (
          <div
            key={idx}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-300 hover:bg-discord-brand-color hover:cursor-default"
          >
        ...
        <div className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-300 hover:bg-[#3ba55c] hover:cursor-default">
          <span className="text-lg font-semibold text-gray-400">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
          <div className="w-full bg-[#202225] text-sm rounded px-2 h-8 flex items-center justify-center text-gray-500 hover:cursor-default">
            Find or start a conversation
          </div>
        </div>
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] hover:cursor-default">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, idx: number) => (
                <div
                  key={idx}
                  className="flex items-center px-2 py-1.5 rounded text-gray-600 hover:cursor-default"
                >
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            <Phone className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <Video className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <Pin className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <UserCircle className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <Search className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <Inbox className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            <HelpCircle className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
          </div>
        </div>
        {/* Message History */}
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            <PlusCircle className="mx-3 text-[#b9bbbe] hover:text-white hover:cursor-default" />
            <input
              type="text"
              readOnly
              placeholder="Message @PingPanda"
              className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus:outline-none hover:cursor-default"
            />
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
              <Sticker className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
              <Smile className="size-5 hover:text-white hover:cursor-default hidden sm:block" />
            </div>
          </div>
        </div>
      </div>
